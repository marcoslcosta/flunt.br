...
namespace Flunt.Br.Document
{
    internal class StateRegistration : IValidate
    {
        ...
        public bool Validate(string value)
        {
            ...
            switch (this.State)
            {
                ...
                case StateEnum.MinasGerais:
                    return this.MinasGerais(value, strOrigem);
                case StateEnum.Para:
                    return this.Para(value, strOrigem);
                case StateEnum.Paraiba:
                    return this.Paraiba(value, strOrigem);
                case StateEnum.Pernambuco:
                    return this.Pernambuco(value, strOrigem);
                case StateEnum.Piaui:
                    return this.Piaui(value, strOrigem);
                case StateEnum.Parana:
                    return this.Parana(value, strOrigem);
                case StateEnum.RioDeJaneiro:
                    return this.RioDeJaneiro(value, strOrigem);
                case StateEnum.RioGrandeDoNorte:
                    return this.RioGrandeDoNorte(value, strOrigem);
                case StateEnum.Rondonia:
                    return this.Rondonia(value, strOrigem);
                case StateEnum.Roraima:
                    return this.Roraima(value, strOrigem);
                case StateEnum.RioGrandeDoSul:
                    return this.RioGrandeDoSul(value, strOrigem);
                case StateEnum.SantaCatarina:
                    return this.SantaCatarina(value, strOrigem);
                case StateEnum.Sergipe:
                    return this.Sergipe(value, strOrigem);
                case StateEnum.SaoPaulo:
                    return this.SaoPaulo(value, strOrigem);
                case StateEnum.Tocantins:
                    return this.Tocantins(value, strOrigem);
        ...
        private bool MinasGerais(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "0000000000000").Substring(0, 13);
        ...
        private bool Para(string value, string strOrigem)
        {
            var retorno = false;
        ...
        private bool Paraiba(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
            intSoma = 0;
        ...
        private bool Pernambuco(string value, string strOrigem)
        {
            var retorno = false;
        ...
        private bool Piaui(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
            intSoma = 0;
        ...
        private bool Parana(string value, string strOrigem)
        {
            var retorno = false;
        ...
        private bool RioDeJaneiro(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "00000000").Substring(0, 8);
            intSoma = 0;
        ...
        private bool RioGrandeDoNorte(string value, string strOrigem)
        {
            var retorno = false;
        ...
        private bool Rondonia(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
        ...
        private bool Roraima(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
        ...
        private bool RioGrandeDoSul(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "0000000000").Substring(0, 10);
        ...
        private bool SantaCatarina(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
            intSoma = 0;
        ...
        private bool Sergipe(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "000000000").Substring(0, 9);
            intSoma = 0;
        ...
        private bool SaoPaulo(string value, string strOrigem)
        {
            var retorno = false;
        ...
        private bool Tocantins(string value, string strOrigem)
        {
            var retorno = false;
            strBase = (strOrigem.Trim() + "00000000000").Substring(0, 11);
